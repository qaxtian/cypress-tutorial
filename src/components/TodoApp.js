...
export default class TodoApp extends Component {
  constructor(props) {
    ...
    this.handleHelloSubmit = this.handleHelloSubmit.bind(this)
  ...
  handleHelloChange(evt) {
    this.setState({ currentHello: evt.target.value })
  }
  ...
  handleHelloSubmit(evt) {
    evt.preventDefault()
    console.log(this.state.currentHello)
  }
    ...
    return (
      <Router>
        <div>
          ...
          <HelloForm
            currentHello={this.state.currentHello}
            handleHelloChange={this.handleHelloChange}
            handleHelloSubmit={this.handleHelloSubmit} />
        </div>
      </Router>
    )
  }
